...
module.exports = {
	...
	jsVendorDeployDestination: './dist/assets/js/', // Path to place the compiled JS vendors file for deployment builds.
	jsVendorFile: 'vendor', // Compiled JS vendors file name. Default set to vendors i.e. vendors.js.

	// JS Custom options.
	jsCustomSRC: './assets/js/custom/*.js', // Path to JS custom scripts folder.
	jsCustomDestination: './assets/js/', // Path to place the compiled JS custom scripts file.
	jsCustomDeployDestination: './dist/assets/js/', // Path to place the compiled JS custom scripts file for deployment builds.
	...
	imgDeploy: './dist/assets/img/', // Destination folder for optimized images for the deployment build.
